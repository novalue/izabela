<template>
  <NvAccessBlocker
    :allowed="
      ...
      [getStoreProperty('apiKey', true), getStoreProperty('region')].every(Boolean)
    "
  ...
  <template v-if="(!form && speechStore.hasUniversalApiCredentials && !getProperty('useLocalCredentials')) ||
