<template>
  <NvAccessBlocker
    :allowed="
      ...
      [ getStoreProperty('publicKey', true), getStoreProperty('privateKey', true), ].every(Boolean)
    "
  ...
  <template
    v-if="
      !form && (getStoreProperty('useLocalCredentials') || !speechStore.hasUniversalApiCredentials)
    "
  >
    <NvDivider direction="horizontal" />
    <NvStack spacing="5">
