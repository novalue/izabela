...
injectGlobal`
  ...
  @media (prefers-color-scheme: dark) {
    ...
    .messenger div div div div span div div { background-color: #111; border-width: 0px; box-shadow: none; color: #fff  }
    .messenger div div div div span div div:hover { background-color: #000000df }
    .messenger div div div div span div div div div div input { background-color: #111; border-width: 0px; box-shadow: none }
    .messenger div div div div span div div div div div input:hover { background-color: #000000df }
    ...
    .autocomplete .autocomplete__list .selected div .option__after button { background-color: #777; border: 0px }
    ...
    .autocomplete .autocomplete__list .deselected div .option__after button { background-color: #777; border: 0px }
